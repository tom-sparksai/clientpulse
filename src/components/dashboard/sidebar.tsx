...
export default function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <aside 
      className="w-72 bg-[rgb(var(--background-elevated))] border-r border-[rgb(var(--border-light))] flex flex-col h-screen"
    ...
    >
      ...
      <div className="p-6 pb-4">
        <Link 
          href="/dashboard" 
          className="flex items-center gap-3 mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--ring))] rounded-xl"
          aria-label="ClientPulse - Go to dashboard"
        >
      ...
      {/* Navigation */}
      <nav className="flex-1 px-4 pb-4" aria-label="Dashboard navigation">
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  {isActive && (
                    <ChevronRight className="w-4 h-4 text-[rgb(var(--primary-400))]" aria-hidden="true" />
                  )}
                </Link>
              </li>
            )
      ...
      <div className="p-4 border-t border-[rgb(var(--border-light))]">
        ...
        <div className="mb-3 p-3 rounded-xl bg-[rgb(var(--neutral-50))] border border-[rgb(var(--border-light))]">
          <div className="flex items-center gap-3">
            <div 
              className="w-10 h-10 rounded-full bg-gradient-to-br from-[rgb(var(--primary-400))] to-[rgb(var(--primary-600))] flex items-center justify-center shadow-sm"
              aria-hidden="true"
            >
        ...
        <button
          ...
          className={cn(
            ...
            'text-[rgb(var(--foreground-secondary))] hover:text-[rgb(var(--error-600))] hover:bg-[rgb(var(--error-50))]',
